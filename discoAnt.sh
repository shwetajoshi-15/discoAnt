...
echo "Quantifying transcripts based on primary alignments to the metagene"
	...
	python $PROGRAMS/flair/flair.py quantify -r $DISCOANT/$GENE/reads_manifest_"$GENE".tsv -i $DISCOANT/$GENE/flair/collapse/default_500.isoforms.fa -o $DISCOANT/$GENE/flair_metagene_counts/default --tpm
