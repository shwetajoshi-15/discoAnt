...
echo "FLAIR - correct and collapse"
	...
	python $PROGRAMS/flair/flair.py collapse -r $ALL/all.fa -q $DISCOANT/$GENE/flair/correct/correct_all_corrected.bed -f $REF_HG38/gencode.v35.annotation.gtf -g $REF_HG38/GRCh38.p13.genome_edit.fa -o $DISCOANT/$GENE/flair/collapse/default_500 --temp_dir $DISCOANT/$GENE/flair -s 500
	python $PROGRAMS/flair/flair.py collapse -r $ALL/all.fa -q $DISCOANT/$GENE/flair/correct/correct_all_corrected.bed -f $REF_HG38/gencode.v35.annotation.gtf -g $REF_HG38/GRCh38.p13.genome_edit.fa -o $DISCOANT/$GENE/flair/collapse/default_100 --temp_dir $DISCOANT/$GENE/flair -s 100
